...
export const optionsLunette = {
  ...
  types: [
    { id: "noir-tachy-orange", nom: "Noir · Tachymètre orange", hex: "#1b1b1b", texte: "#ff7a1a" },
    { id: "bleu-tachy-orange", nom: "Bleu · Tachymètre orange", hex: "#2c477a", texte: "#ff7a1a" },
    { id: "rouge",             nom: "Rouge",                     hex: "#9b2f2f", texte: "#ffffff" },
    { id: "vert",              nom: "Vert",                      hex: "#2f6b43", texte: "#ffffff" },
    { id: "bleu",              nom: "Bleu",                      hex: "#2c477a", texte: "#ffffff" },
    { id: "noir",              nom: "Noir",                      hex: "#1b1b1b", texte: "#ffffff" },
